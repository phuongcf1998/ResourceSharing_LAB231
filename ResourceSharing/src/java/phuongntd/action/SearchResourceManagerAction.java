 ...
 * @author HOME
 */
public class SearchResourceManagerAction {

    private static final Logger LOGGER = Logger.getLogger(SearchResourceManagerAction.class.getName());
    ...
    public SearchResourceManagerAction() {
    }
    ...
    public String execute() {
        ...
        if (session != null) {
            ...
            try {
                ...
                LOGGER.error("SearchResourceManagerAction_SQLException " + ex.getMessage());
            } catch (NamingException ex) {
                LOGGER.error("SearchResourceManagerAction_NamingException " + ex.getMessage());
            }
