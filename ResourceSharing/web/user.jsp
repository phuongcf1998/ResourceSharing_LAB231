...
<html>
    ...
    <body>
        ...
        <div style="margin-left: 25px">
            <font color="red"><h1>Welcome ,<s:property value="%{#session.USER.fullName}"/></h1> </font> <br/><br/>


            <div style="display: flex;flex-direction: row;">
                <a class="btn btn-primary mbutton" href="logOut"><h3>Log out</h3></a>

                <a class="btn btn-success mbutton" href="viewCart"><h3>View Your Cart</h3></a>
                <a class="btn btn-info mbutton" href="viewHistory"><h3>View History</h3></a>
            </div>
        ...
        <div style="margin-left: 150px;">
            ...
            <form  action="searchResourceUser">
                <div class="form-row">
                    <div class="col-2">
            ...
            <s:if test="%{#request.listResource != null && #request.totalPage!=null}">
                ...
                <div class="center">
                    <s:iterator  begin="1" end="%{#request.totalPage}" status="counter">
                        <s:url action="searchResourceUser" id="currentPage" >  
                ...
                <s:if test="%{#request.fullQuantity != null}">
                    <span style="color: red"><s:property value="#request.fullQuantity" /></span>
                    <br/>
                </s:if>
                <br/>
                <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <s:if test="%{quantity > 0}">
                                            <s:url action="addToCart" id="addCartLink" >
                                                <s:param name="id"><s:property value="resourceID"/></s:param>
                                                <s:param name="name"><s:property value="%{#parameters.name}"/></s:param>
                                                <s:param name="category"><s:property value="%{#parameters.category}"/></s:param>
                                                <s:param name="fromDate"><s:property value="%{#parameters.fromDate}"/></s:param>
                                                <s:param name="toDate"><s:property value="%{#parameters.toDate}"/></s:param>
                                                <s:param name="page"><s:property value="%{#parameters.page}"/></s:param>
                                            </s:url>
                                            <s:a href="%{addCartLink}"><i class="fa fa-shopping-cart" style="font-size:20px"></i> Add to cart</s:a>
                                        </s:if>
                                        <s:if test="%{quantity == 0}">
